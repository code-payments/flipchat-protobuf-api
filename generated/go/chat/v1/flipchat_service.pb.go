...
type JoinChatPaymentMetadata struct {
	...
	// Types that are assignable to Identifier:
	//
	//	*JoinChatPaymentMetadata_ChatId
	//	*JoinChatPaymentMetadata_RoomId
	Identifier isJoinChatPaymentMetadata_Identifier `protobuf_oneof:"identifier"`
}
...
func (m *JoinChatPaymentMetadata) GetIdentifier() isJoinChatPaymentMetadata_Identifier {
	if m != nil {
		return m.Identifier
	}
	return nil
...
func (x *JoinChatPaymentMetadata) GetChatId() *v1.ChatId {
	if x, ok := x.GetIdentifier().(*JoinChatPaymentMetadata_ChatId); ok {
		return x.ChatId
	}
	return nil
}

func (x *JoinChatPaymentMetadata) GetRoomId() uint64 {
	if x, ok := x.GetIdentifier().(*JoinChatPaymentMetadata_RoomId); ok {
		return x.RoomId
	}
	return 0
}

type isJoinChatPaymentMetadata_Identifier interface {
	isJoinChatPaymentMetadata_Identifier()
}

type JoinChatPaymentMetadata_ChatId struct {
	ChatId *v1.ChatId `protobuf:"bytes,2,opt,name=chat_id,json=chatId,proto3,oneof"`
}

type JoinChatPaymentMetadata_RoomId struct {
	RoomId uint64 `protobuf:"varint,3,opt,name=room_id,json=roomId,proto3,oneof"`
}

func (*JoinChatPaymentMetadata_ChatId) isJoinChatPaymentMetadata_Identifier() {}

func (*JoinChatPaymentMetadata_RoomId) isJoinChatPaymentMetadata_Identifier() {}
...
var file_chat_v1_flipchat_service_proto_rawDesc = []byte{
	...
	0xae, 0x01, 0x0a, 0x0f, 0x4a, 0x6f, 0x69, 0x6e, 0x43, 0x68, 0x61, 0x74, 0x52, 0x65, 0x71, 0x75,
	...
	0x6f, 0x6f, 0x6d, 0x49, 0x64, 0x12, 0x36, 0x0a, 0x04, 0x61, 0x75, 0x74, 0x68, 0x18, 0x0a, 0x20,
	...
	0x10, 0x01, 0x22, 0xbd, 0x01, 0x0a, 0x17, 0x4a, 0x6f, 0x69, 0x6e, 0x43, 0x68, 0x61, 0x74, 0x50,
	...
	0x8a, 0x01, 0x02, 0x10, 0x01, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x35, 0x0a,
	...
	0x03, 0x20, 0x01, 0x28, 0x04, 0x48, 0x00, 0x52, 0x06, 0x72, 0x6f, 0x6f, 0x6d, 0x49, 0x64, 0x42,
	0x11, 0x0a, 0x0a, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x65, 0x72, 0x12, 0x03, 0xf8,
	0x42, 0x01, 0x22, 0x89, 0x01, 0x0a, 0x10, 0x4c, 0x65, 0x61, 0x76, 0x65, 0x43, 0x68, 0x61, 0x74,
	...
	0x74, 0x12, 0x06, 0x0a, 0x02, 0x4f, 0x4b, 0x10, 0x00, 0x22, 0xa7, 0x01, 0x0a, 0x13, 0x53, 0x65,
	...
	,
	...
	0x75, 0x6c, 0x74, 0x22, 0x2b, 0x0a, 0x06, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x12, 0x06, 0x0a,
	0x02, 0x4f, 0x4b, 0x10, 0x00, 0x12, 0x0a, 0x0a, 0x06, 0x44, 0x45, 0x4e, 0x49, 0x45, 0x44, 0x10,
	0x01, 0x12, 0x0d, 0x0a, 0x09, 0x43, 0x41, 0x4e, 0x54, 0x5f, 0x4d, 0x55, 0x54, 0x45, 0x10, 0x02,
	0x22, 0x88, 0x03, 0x0a, 0x08, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x3d, 0x0a,
	...
	0xfa, 0x42, 0x07, 0x72, 0x05, 0x10, 0x00, 0x18, 0x80, 0x08, 0x52, 0x05, 0x74, 0x69, 0x74, 0x6c,
	...
	0x65, 0x72, 0x12, 0x19, 0x0a, 0x08, 0x69, 0x73, 0x5f, 0x6d, 0x75, 0x74, 0x65, 0x64, 0x18, 0x05,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x69, 0x73, 0x4d, 0x75, 0x74, 0x65, 0x64, 0x12, 0x1a, 0x0a,
	0x08, 0x6d, 0x75, 0x74, 0x65, 0x61, 0x62, 0x6c, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x08, 0x52,
	...
	0x72, 0x49, 0x64, 0x52, 0x05, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x22, 0x2f, 0x0a, 0x08, 0x43, 0x68,
	...
	0x12, 0x09, 0x0a, 0x05, 0x47, 0x52, 0x4f, 0x55, 0x50, 0x10, 0x02, 0x22, 0xff, 0x01, 0x0a, 0x06,
	...
	0x53, 0x65, 0x6c, 0x66, 0x12, 0x17, 0x0a, 0x07, 0x69, 0x73, 0x5f, 0x68, 0x6f, 0x73, 0x74, 0x18,
	0x05, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x69, 0x73, 0x48, 0x6f, 0x73, 0x74, 0x22, 0x6f, 0x0a,
...
var file_chat_v1_flipchat_service_proto_goTypes = []any{
	...
	(*v1.UserId)(nil),                                         // 40: flipchat.common.v1.UserId
	(*v11.Pointer)(nil),                                       // 41: flipchat.messaging.v1.Pointer
	(*timestamppb.Timestamp)(nil),                             // 42: google.protobuf.Timestamp
	(*v11.Message)(nil),                                       // 43: flipchat.messaging.v1.Message
	(*v11.IsTyping)(nil),                                      // 44: flipchat.messaging.v1.IsTyping
}
var file_chat_v1_flipchat_service_proto_depIdxs = []int32{
	...
	38, // 20: flipchat.chat.v1.JoinChatRequest.auth:type_name -> flipchat.common.v1.Auth
	4,  // 21: flipchat.chat.v1.JoinChatResponse.result:type_name -> flipchat.chat.v1.JoinChatResponse.Result
	23, // 22: flipchat.chat.v1.JoinChatResponse.metadata:type_name -> flipchat.chat.v1.Metadata
	24, // 23: flipchat.chat.v1.JoinChatResponse.members:type_name -> flipchat.chat.v1.Member
	40, // 24: flipchat.chat.v1.JoinChatPaymentMetadata.user_id:type_name -> flipchat.common.v1.UserId
	39, // 25: flipchat.chat.v1.JoinChatPaymentMetadata.chat_id:type_name -> flipchat.common.v1.ChatId
	39, // 26: flipchat.chat.v1.LeaveChatRequest.chat_id:type_name -> flipchat.common.v1.ChatId
	38, // 27: flipchat.chat.v1.LeaveChatRequest.auth:type_name -> flipchat.common.v1.Auth
	5,  // 28: flipchat.chat.v1.LeaveChatResponse.result:type_name -> flipchat.chat.v1.LeaveChatResponse.Result
	39, // 29: flipchat.chat.v1.SetMuteStateRequest.chat_id:type_name -> flipchat.common.v1.ChatId
	38, // 30: flipchat.chat.v1.SetMuteStateRequest.auth:type_name -> flipchat.common.v1.Auth
	6,  // 31: flipchat.chat.v1.SetMuteStateResponse.result:type_name -> flipchat.chat.v1.SetMuteStateResponse.Result
	39, // 32: flipchat.chat.v1.Metadata.chat_id:type_name -> flipchat.common.v1.ChatId
	7,  // 33: flipchat.chat.v1.Metadata.type:type_name -> flipchat.chat.v1.Metadata.ChatType
	40, // 34: flipchat.chat.v1.Metadata.owner:type_name -> flipchat.common.v1.UserId
	40, // 35: flipchat.chat.v1.Member.user_id:type_name -> flipchat.common.v1.UserId
	25, // 36: flipchat.chat.v1.Member.identity:type_name -> flipchat.chat.v1.MemberIdentity
	41, // 37: flipchat.chat.v1.Member.pointers:type_name -> flipchat.messaging.v1.Pointer
	38, // 38: flipchat.chat.v1.StreamChatEventsRequest.Params.auth:type_name -> flipchat.common.v1.Auth
	42, // 39: flipchat.chat.v1.StreamChatEventsRequest.Params.ts:type_name -> google.protobuf.Timestamp
	0,  // 40: flipchat.chat.v1.StreamChatEventsResponse.StreamError.code:type_name -> flipchat.chat.v1.StreamChatEventsResponse.StreamError.Code
	29, // 41: flipchat.chat.v1.StreamChatEventsResponse.EventBatch.updates:type_name -> flipchat.chat.v1.StreamChatEventsResponse.ChatUpdate
	39, // 42: flipchat.chat.v1.StreamChatEventsResponse.ChatUpdate.chat_id:type_name -> flipchat.common.v1.ChatId
	23, // 43: flipchat.chat.v1.StreamChatEventsResponse.ChatUpdate.metadata:type_name -> flipchat.chat.v1.Metadata
	30, // 44: flipchat.chat.v1.StreamChatEventsResponse.ChatUpdate.member_update:type_name -> flipchat.chat.v1.StreamChatEventsResponse.MemberUpdate
	43, // 45: flipchat.chat.v1.StreamChatEventsResponse.ChatUpdate.last_message:type_name -> flipchat.messaging.v1.Message
	...
	44, // 47: flipchat.chat.v1.StreamChatEventsResponse.ChatUpdate.is_typing:type_name -> flipchat.messaging.v1.IsTyping
	32, // 48: flipchat.chat.v1.StreamChatEventsResponse.MemberUpdate.refresh:type_name -> flipchat.chat.v1.StreamChatEventsResponse.MemberUpdate.Refresh
	40, // 49: flipchat.chat.v1.StreamChatEventsResponse.ChatUpdate.PointerUpdate.member:type_name -> flipchat.common.v1.UserId
	41, // 50: flipchat.chat.v1.StreamChatEventsResponse.ChatUpdate.PointerUpdate.pointer:type_name -> flipchat.messaging.v1.Pointer
	24, // 51: flipchat.chat.v1.StreamChatEventsResponse.MemberUpdate.Refresh.members:type_name -> flipchat.chat.v1.Member
	40, // 52: flipchat.chat.v1.StartChatRequest.StartTwoWayChatParameters.other_user_id:type_name -> flipchat.common.v1.UserId
	40, // 53: flipchat.chat.v1.StartChatRequest.StartGroupChatParameters.users:type_name -> flipchat.common.v1.UserId
	8,  // 54: flipchat.chat.v1.Chat.StreamChatEvents:input_type -> flipchat.chat.v1.StreamChatEventsRequest
	10, // 55: flipchat.chat.v1.Chat.GetChats:input_type -> flipchat.chat.v1.GetChatsRequest
	12, // 56: flipchat.chat.v1.Chat.GetChat:input_type -> flipchat.chat.v1.GetChatRequest
	14, // 57: flipchat.chat.v1.Chat.StartChat:input_type -> flipchat.chat.v1.StartChatRequest
	16, // 58: flipchat.chat.v1.Chat.JoinChat:input_type -> flipchat.chat.v1.JoinChatRequest
	19, // 59: flipchat.chat.v1.Chat.LeaveChat:input_type -> flipchat.chat.v1.LeaveChatRequest
	21, // 60: flipchat.chat.v1.Chat.SetMuteState:input_type -> flipchat.chat.v1.SetMuteStateRequest
	9,  // 61: flipchat.chat.v1.Chat.StreamChatEvents:output_type -> flipchat.chat.v1.StreamChatEventsResponse
	11, // 62: flipchat.chat.v1.Chat.GetChats:output_type -> flipchat.chat.v1.GetChatsResponse
	13, // 63: flipchat.chat.v1.Chat.GetChat:output_type -> flipchat.chat.v1.GetChatResponse
	15, // 64: flipchat.chat.v1.Chat.StartChat:output_type -> flipchat.chat.v1.StartChatResponse
	17, // 65: flipchat.chat.v1.Chat.JoinChat:output_type -> flipchat.chat.v1.JoinChatResponse
	20, // 66: flipchat.chat.v1.Chat.LeaveChat:output_type -> flipchat.chat.v1.LeaveChatResponse
	22, // 67: flipchat.chat.v1.Chat.SetMuteState:output_type -> flipchat.chat.v1.SetMuteStateResponse
...
func file_chat_v1_flipchat_service_proto_init() {
	...
	file_chat_v1_flipchat_service_proto_msgTypes[10].OneofWrappers = []any{
		(*JoinChatPaymentMetadata_ChatId)(nil),
		(*JoinChatPaymentMetadata_RoomId)(nil),
	}
