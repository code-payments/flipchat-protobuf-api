...
var file_chat_v1_flipchat_service_proto_rawDesc = []byte{
	...
	0x4f, 0x4b, 0x10, 0x00, 0x22, 0xaa, 0x04, 0x0a, 0x08, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74,
	...
	0x02, 0x22, 0x9a, 0x02, 0x0a, 0x06, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x3d, 0x0a, 0x07,
	0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e,
	0x66, 0x6c, 0x69, 0x70, 0x63, 0x68, 0x61, 0x74, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e,
	0x76, 0x31, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x49, 0x64, 0x42, 0x08, 0xfa, 0x42, 0x05, 0x8a, 0x01,
	...
	0x28, 0x08, 0x52, 0x06, 0x69, 0x73, 0x53, 0x65, 0x6c, 0x66, 0x12, 0x17, 0x0a, 0x07, 0x69, 0x73,
	0x5f, 0x68, 0x6f, 0x73, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x69, 0x73, 0x48,
	0x6f, 0x73, 0x74, 0x12, 0x19, 0x0a, 0x08, 0x69, 0x73, 0x5f, 0x6d, 0x75, 0x74, 0x65, 0x64, 0x18,
...
var file_chat_v1_flipchat_service_proto_depIdxs = []int32{
	...
	60, // 57: flipchat.chat.v1.Metadata.last_activity:type_name -> google.protobuf.Timestamp
	56, // 58: flipchat.chat.v1.Member.user_id:type_name -> flipchat.common.v1.UserId
	41, // 59: flipchat.chat.v1.Member.identity:type_name -> flipchat.chat.v1.MemberIdentity
	61, // 60: flipchat.chat.v1.Member.pointers:type_name -> flipchat.messaging.v1.Pointer
	54, // 61: flipchat.chat.v1.StreamChatEventsRequest.Params.auth:type_name -> flipchat.common.v1.Auth
	60, // 62: flipchat.chat.v1.StreamChatEventsRequest.Params.ts:type_name -> google.protobuf.Timestamp
	0,  // 63: flipchat.chat.v1.StreamChatEventsResponse.StreamError.code:type_name -> flipchat.chat.v1.StreamChatEventsResponse.StreamError.Code
	45, // 64: flipchat.chat.v1.StreamChatEventsResponse.EventBatch.updates:type_name -> flipchat.chat.v1.StreamChatEventsResponse.ChatUpdate
	55, // 65: flipchat.chat.v1.StreamChatEventsResponse.ChatUpdate.chat_id:type_name -> flipchat.common.v1.ChatId
	39, // 66: flipchat.chat.v1.StreamChatEventsResponse.ChatUpdate.metadata:type_name -> flipchat.chat.v1.Metadata
	46, // 67: flipchat.chat.v1.StreamChatEventsResponse.ChatUpdate.member_update:type_name -> flipchat.chat.v1.StreamChatEventsResponse.MemberUpdate
	62, // 68: flipchat.chat.v1.StreamChatEventsResponse.ChatUpdate.last_message:type_name -> flipchat.messaging.v1.Message
	47, // 69: flipchat.chat.v1.StreamChatEventsResponse.ChatUpdate.pointer:type_name -> flipchat.chat.v1.StreamChatEventsResponse.ChatUpdate.PointerUpdate
	63, // 70: flipchat.chat.v1.StreamChatEventsResponse.ChatUpdate.is_typing:type_name -> flipchat.messaging.v1.IsTyping
	48, // 71: flipchat.chat.v1.StreamChatEventsResponse.MemberUpdate.refresh:type_name -> flipchat.chat.v1.StreamChatEventsResponse.MemberUpdate.Refresh
	56, // 72: flipchat.chat.v1.StreamChatEventsResponse.ChatUpdate.PointerUpdate.member:type_name -> flipchat.common.v1.UserId
	61, // 73: flipchat.chat.v1.StreamChatEventsResponse.ChatUpdate.PointerUpdate.pointer:type_name -> flipchat.messaging.v1.Pointer
	40, // 74: flipchat.chat.v1.StreamChatEventsResponse.MemberUpdate.Refresh.members:type_name -> flipchat.chat.v1.Member
	56, // 75: flipchat.chat.v1.StartChatRequest.StartTwoWayChatParameters.other_user_id:type_name -> flipchat.common.v1.UserId
	56, // 76: flipchat.chat.v1.StartChatRequest.StartGroupChatParameters.users:type_name -> flipchat.common.v1.UserId
	57, // 77: flipchat.chat.v1.StartChatRequest.StartGroupChatParameters.payment_intent:type_name -> flipchat.common.v1.IntentId
	13, // 78: flipchat.chat.v1.Chat.StreamChatEvents:input_type -> flipchat.chat.v1.StreamChatEventsRequest
	15, // 79: flipchat.chat.v1.Chat.GetChats:input_type -> flipchat.chat.v1.GetChatsRequest
	17, // 80: flipchat.chat.v1.Chat.GetChat:input_type -> flipchat.chat.v1.GetChatRequest
	19, // 81: flipchat.chat.v1.Chat.StartChat:input_type -> flipchat.chat.v1.StartChatRequest
	22, // 82: flipchat.chat.v1.Chat.JoinChat:input_type -> flipchat.chat.v1.JoinChatRequest
	25, // 83: flipchat.chat.v1.Chat.LeaveChat:input_type -> flipchat.chat.v1.LeaveChatRequest
	27, // 84: flipchat.chat.v1.Chat.SetCoverCharge:input_type -> flipchat.chat.v1.SetCoverChargeRequest
	29, // 85: flipchat.chat.v1.Chat.RemoveUser:input_type -> flipchat.chat.v1.RemoveUserRequest
	31, // 86: flipchat.chat.v1.Chat.MuteUser:input_type -> flipchat.chat.v1.MuteUserRequest
	33, // 87: flipchat.chat.v1.Chat.MuteChat:input_type -> flipchat.chat.v1.MuteChatRequest
	35, // 88: flipchat.chat.v1.Chat.UnmuteChat:input_type -> flipchat.chat.v1.UnmuteChatRequest
	37, // 89: flipchat.chat.v1.Chat.ReportUser:input_type -> flipchat.chat.v1.ReportUserRequest
	14, // 90: flipchat.chat.v1.Chat.StreamChatEvents:output_type -> flipchat.chat.v1.StreamChatEventsResponse
	16, // 91: flipchat.chat.v1.Chat.GetChats:output_type -> flipchat.chat.v1.GetChatsResponse
	18, // 92: flipchat.chat.v1.Chat.GetChat:output_type -> flipchat.chat.v1.GetChatResponse
	20, // 93: flipchat.chat.v1.Chat.StartChat:output_type -> flipchat.chat.v1.StartChatResponse
	23, // 94: flipchat.chat.v1.Chat.JoinChat:output_type -> flipchat.chat.v1.JoinChatResponse
	26, // 95: flipchat.chat.v1.Chat.LeaveChat:output_type -> flipchat.chat.v1.LeaveChatResponse
	28, // 96: flipchat.chat.v1.Chat.SetCoverCharge:output_type -> flipchat.chat.v1.SetCoverChargeResponse
	30, // 97: flipchat.chat.v1.Chat.RemoveUser:output_type -> flipchat.chat.v1.RemoveUserResponse
	32, // 98: flipchat.chat.v1.Chat.MuteUser:output_type -> flipchat.chat.v1.MuteUserResponse
	34, // 99: flipchat.chat.v1.Chat.MuteChat:output_type -> flipchat.chat.v1.MuteChatResponse
	36, // 100: flipchat.chat.v1.Chat.UnmuteChat:output_type -> flipchat.chat.v1.UnmuteChatResponse
	38, // 101: flipchat.chat.v1.Chat.ReportUser:output_type -> flipchat.chat.v1.ReportUserResponse
