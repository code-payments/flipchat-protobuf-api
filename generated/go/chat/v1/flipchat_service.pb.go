...
var file_chat_v1_flipchat_service_proto_rawDesc = []byte{
	...
	0x0a, 0x02, 0x4f, 0x4b, 0x10, 0x00, 0x22, 0xce, 0x03, 0x0a, 0x08, 0x4d, 0x65, 0x74, 0x61, 0x64,
	...
	0x66, 0x69, 0x6c, 0x65, 0x50, 0x69, 0x63, 0x55, 0x72, 0x6c, 0x32, 0x8d, 0x07, 0x0a, 0x04, 0x43,
...
var file_chat_v1_flipchat_service_proto_goTypes = []any{
	...
	(*SetMuteStateRequest)(nil),                               // 25: flipchat.chat.v1.SetMuteStateRequest
	(*SetMuteStateResponse)(nil),                              // 26: flipchat.chat.v1.SetMuteStateResponse
...
var file_chat_v1_flipchat_service_proto_depIdxs = []int32{
	...
	49, // 31: flipchat.chat.v1.SetMuteStateRequest.chat_id:type_name -> flipchat.common.v1.ChatId
	48, // 32: flipchat.chat.v1.SetMuteStateRequest.auth:type_name -> flipchat.common.v1.Auth
	6,  // 33: flipchat.chat.v1.SetMuteStateResponse.result:type_name -> flipchat.chat.v1.SetMuteStateResponse.Result
	49, // 34: flipchat.chat.v1.SetCoverChargeRequest.chat_id:type_name -> flipchat.common.v1.ChatId
	52, // 35: flipchat.chat.v1.SetCoverChargeRequest.cover_charge:type_name -> flipchat.common.v1.PaymentAmount
	48, // 36: flipchat.chat.v1.SetCoverChargeRequest.auth:type_name -> flipchat.common.v1.Auth
	7,  // 37: flipchat.chat.v1.SetCoverChargeResponse.result:type_name -> flipchat.chat.v1.SetCoverChargeResponse.Result
	49, // 38: flipchat.chat.v1.RemoveUserRequest.chat_id:type_name -> flipchat.common.v1.ChatId
	50, // 39: flipchat.chat.v1.RemoveUserRequest.user_id:type_name -> flipchat.common.v1.UserId
	48, // 40: flipchat.chat.v1.RemoveUserRequest.auth:type_name -> flipchat.common.v1.Auth
	8,  // 41: flipchat.chat.v1.RemoveUserResponse.result:type_name -> flipchat.chat.v1.RemoveUserResponse.Result
	50, // 42: flipchat.chat.v1.ReportUserRequest.user_id:type_name -> flipchat.common.v1.UserId
	53, // 43: flipchat.chat.v1.ReportUserRequest.message_id:type_name -> flipchat.messaging.v1.MessageId
	48, // 44: flipchat.chat.v1.ReportUserRequest.auth:type_name -> flipchat.common.v1.Auth
	9,  // 45: flipchat.chat.v1.ReportUserResponse.result:type_name -> flipchat.chat.v1.ReportUserResponse.Result
	49, // 46: flipchat.chat.v1.Metadata.chat_id:type_name -> flipchat.common.v1.ChatId
	10, // 47: flipchat.chat.v1.Metadata.type:type_name -> flipchat.chat.v1.Metadata.ChatType
	50, // 48: flipchat.chat.v1.Metadata.owner:type_name -> flipchat.common.v1.UserId
	52, // 49: flipchat.chat.v1.Metadata.cover_charge:type_name -> flipchat.common.v1.PaymentAmount
	50, // 50: flipchat.chat.v1.Member.user_id:type_name -> flipchat.common.v1.UserId
	35, // 51: flipchat.chat.v1.Member.identity:type_name -> flipchat.chat.v1.MemberIdentity
	54, // 52: flipchat.chat.v1.Member.pointers:type_name -> flipchat.messaging.v1.Pointer
	48, // 53: flipchat.chat.v1.StreamChatEventsRequest.Params.auth:type_name -> flipchat.common.v1.Auth
	55, // 54: flipchat.chat.v1.StreamChatEventsRequest.Params.ts:type_name -> google.protobuf.Timestamp
	0,  // 55: flipchat.chat.v1.StreamChatEventsResponse.StreamError.code:type_name -> flipchat.chat.v1.StreamChatEventsResponse.StreamError.Code
	39, // 56: flipchat.chat.v1.StreamChatEventsResponse.EventBatch.updates:type_name -> flipchat.chat.v1.StreamChatEventsResponse.ChatUpdate
	49, // 57: flipchat.chat.v1.StreamChatEventsResponse.ChatUpdate.chat_id:type_name -> flipchat.common.v1.ChatId
	33, // 58: flipchat.chat.v1.StreamChatEventsResponse.ChatUpdate.metadata:type_name -> flipchat.chat.v1.Metadata
	40, // 59: flipchat.chat.v1.StreamChatEventsResponse.ChatUpdate.member_update:type_name -> flipchat.chat.v1.StreamChatEventsResponse.MemberUpdate
	56, // 60: flipchat.chat.v1.StreamChatEventsResponse.ChatUpdate.last_message:type_name -> flipchat.messaging.v1.Message
	41, // 61: flipchat.chat.v1.StreamChatEventsResponse.ChatUpdate.pointer:type_name -> flipchat.chat.v1.StreamChatEventsResponse.ChatUpdate.PointerUpdate
	57, // 62: flipchat.chat.v1.StreamChatEventsResponse.ChatUpdate.is_typing:type_name -> flipchat.messaging.v1.IsTyping
	42, // 63: flipchat.chat.v1.StreamChatEventsResponse.MemberUpdate.refresh:type_name -> flipchat.chat.v1.StreamChatEventsResponse.MemberUpdate.Refresh
	50, // 64: flipchat.chat.v1.StreamChatEventsResponse.ChatUpdate.PointerUpdate.member:type_name -> flipchat.common.v1.UserId
	54, // 65: flipchat.chat.v1.StreamChatEventsResponse.ChatUpdate.PointerUpdate.pointer:type_name -> flipchat.messaging.v1.Pointer
	34, // 66: flipchat.chat.v1.StreamChatEventsResponse.MemberUpdate.Refresh.members:type_name -> flipchat.chat.v1.Member
	50, // 67: flipchat.chat.v1.StartChatRequest.StartTwoWayChatParameters.other_user_id:type_name -> flipchat.common.v1.UserId
	50, // 68: flipchat.chat.v1.StartChatRequest.StartGroupChatParameters.users:type_name -> flipchat.common.v1.UserId
	51, // 69: flipchat.chat.v1.StartChatRequest.StartGroupChatParameters.payment_intent:type_name -> flipchat.common.v1.IntentId
	11, // 70: flipchat.chat.v1.Chat.StreamChatEvents:input_type -> flipchat.chat.v1.StreamChatEventsRequest
	13, // 71: flipchat.chat.v1.Chat.GetChats:input_type -> flipchat.chat.v1.GetChatsRequest
	15, // 72: flipchat.chat.v1.Chat.GetChat:input_type -> flipchat.chat.v1.GetChatRequest
	17, // 73: flipchat.chat.v1.Chat.StartChat:input_type -> flipchat.chat.v1.StartChatRequest
	20, // 74: flipchat.chat.v1.Chat.JoinChat:input_type -> flipchat.chat.v1.JoinChatRequest
	23, // 75: flipchat.chat.v1.Chat.LeaveChat:input_type -> flipchat.chat.v1.LeaveChatRequest
	25, // 76: flipchat.chat.v1.Chat.SetMuteState:input_type -> flipchat.chat.v1.SetMuteStateRequest
	27, // 77: flipchat.chat.v1.Chat.SetCoverCharge:input_type -> flipchat.chat.v1.SetCoverChargeRequest
	29, // 78: flipchat.chat.v1.Chat.RemoveUser:input_type -> flipchat.chat.v1.RemoveUserRequest
	31, // 79: flipchat.chat.v1.Chat.ReportUser:input_type -> flipchat.chat.v1.ReportUserRequest
	12, // 80: flipchat.chat.v1.Chat.StreamChatEvents:output_type -> flipchat.chat.v1.StreamChatEventsResponse
	14, // 81: flipchat.chat.v1.Chat.GetChats:output_type -> flipchat.chat.v1.GetChatsResponse
	16, // 82: flipchat.chat.v1.Chat.GetChat:output_type -> flipchat.chat.v1.GetChatResponse
	18, // 83: flipchat.chat.v1.Chat.StartChat:output_type -> flipchat.chat.v1.StartChatResponse
	21, // 84: flipchat.chat.v1.Chat.JoinChat:output_type -> flipchat.chat.v1.JoinChatResponse
	24, // 85: flipchat.chat.v1.Chat.LeaveChat:output_type -> flipchat.chat.v1.LeaveChatResponse
	26, // 86: flipchat.chat.v1.Chat.SetMuteState:output_type -> flipchat.chat.v1.SetMuteStateResponse
	28, // 87: flipchat.chat.v1.Chat.SetCoverCharge:output_type -> flipchat.chat.v1.SetCoverChargeResponse
	30, // 88: flipchat.chat.v1.Chat.RemoveUser:output_type -> flipchat.chat.v1.RemoveUserResponse
	32, // 89: flipchat.chat.v1.Chat.ReportUser:output_type -> flipchat.chat.v1.ReportUserResponse
