...
// Validate checks the field values on PreviewId with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *PreviewId) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on PreviewId with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in PreviewIdMultiError, or nil
// if none found.
func (m *PreviewId) ValidateAll() error {
	return m.validate(true)
}

func (m *PreviewId) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return PreviewIdMultiError(errors)
	}

	return nil
}

// PreviewIdMultiError is an error wrapping multiple validation errors returned
// by PreviewId.ValidateAll() if the designated constraints aren't met.
type PreviewIdMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m PreviewIdMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m PreviewIdMultiError) AllErrors() []error { return m }

// PreviewIdValidationError is the validation error returned by
// PreviewId.Validate if the designated constraints aren't met.
type PreviewIdValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e PreviewIdValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e PreviewIdValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e PreviewIdValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e PreviewIdValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e PreviewIdValidationError) ErrorName() string { return "PreviewIdValidationError" }

// Error satisfies the builtin error interface
func (e PreviewIdValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = PreviewIdValidationError{}
