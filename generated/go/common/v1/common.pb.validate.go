...
// Validate checks the field values on LocalizedButton with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *LocalizedButton) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on LocalizedButton with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// LocalizedButtonMultiError, or nil if none found.
func (m *LocalizedButton) ValidateAll() error {
	return m.validate(true)
}

func (m *LocalizedButton) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if l := utf8.RuneCountInString(m.GetKeyOrText()); l < 1 || l > 1024 {
		err := LocalizedButtonValidationError{
			field:  "KeyOrText",
	...
	if l := utf8.RuneCountInString(m.GetLink()); l < 1 || l > 1024 {
		err := LocalizedButtonValidationError{
			field:  "Link",
			reason: "value length must be between 1 and 1024 runes, inclusive",
		}
	...
	if len(errors) > 0 {
		return LocalizedButtonMultiError(errors)
	}

	return nil
}

// LocalizedButtonMultiError is an error wrapping multiple validation errors
// returned by LocalizedButton.ValidateAll() if the designated constraints
// aren't met.
type LocalizedButtonMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m LocalizedButtonMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m LocalizedButtonMultiError) AllErrors() []error { return m }

// LocalizedButtonValidationError is the validation error returned by
// LocalizedButton.Validate if the designated constraints aren't met.
type LocalizedButtonValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e LocalizedButtonValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e LocalizedButtonValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e LocalizedButtonValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e LocalizedButtonValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e LocalizedButtonValidationError) ErrorName() string { return "LocalizedButtonValidationError" }

// Error satisfies the builtin error interface
func (e LocalizedButtonValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sLocalizedButton.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = LocalizedButtonValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = LocalizedButtonValidationError{}
