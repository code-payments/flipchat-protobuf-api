...
var file_account_v1_account_service_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xce, 0x01, 0x0a, 0x0f, 0x52, 0x65, 0x67, 0x69,
	0x73, 0x74, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x46, 0x0a, 0x0a, 0x70,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x66, 0x6c, 0x69, 0x70, 0x63, 0x68, 0x61,
	...
	0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x12, 0x2c, 0x0a, 0x0c, 0x64, 0x69,
	...
	0x70, 0x6c, 0x61, 0x79, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0xf3, 0x01, 0x0a, 0x10, 0x52, 0x65, 0x67,
	...
	0x75, 0x6c, 0x74, 0x12, 0x21, 0x0a, 0x0c, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x5f, 0x72, 0x65, 0x61,
	0x73, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x65, 0x72, 0x72, 0x6f, 0x72,
	0x52, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x12, 0x33, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69,
	0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x66, 0x6c, 0x69, 0x70, 0x63, 0x68,
	0x61, 0x74, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x2e, 0x55, 0x73, 0x65,
	0x72, 0x49, 0x64, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x41, 0x0a, 0x06, 0x52,
	...
	0x52, 0x45, 0x10, 0x01, 0x12, 0x18, 0x0a, 0x14, 0x49, 0x4e, 0x56, 0x41, 0x4c, 0x49, 0x44, 0x5f,
	0x44, 0x49, 0x53, 0x50, 0x4c, 0x41, 0x59, 0x5f, 0x4e, 0x41, 0x4d, 0x45, 0x10, 0x02, 0x22, 0xa1,
	...
	0x10, 0x02, 0x32, 0xc7, 0x02, 0x0a, 0x07, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x57,
...
var file_account_v1_account_service_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
...
var file_account_v1_account_service_proto_goTypes = []any{
	...
	(AuthorizePublicKeyResponse_Result)(0), // 1: flipchat.account.v1.AuthorizePublicKeyResponse.Result
	(RevokePublicKeyResponse_Result)(0),    // 2: flipchat.account.v1.RevokePublicKeyResponse.Result
	(*RegisterRequest)(nil),                // 3: flipchat.account.v1.RegisterRequest
	(*RegisterResponse)(nil),               // 4: flipchat.account.v1.RegisterResponse
	(*AuthorizePublicKeyRequest)(nil),      // 5: flipchat.account.v1.AuthorizePublicKeyRequest
	(*AuthorizePublicKeyResponse)(nil),     // 6: flipchat.account.v1.AuthorizePublicKeyResponse
	(*RevokePublicKeyRequest)(nil),         // 7: flipchat.account.v1.RevokePublicKeyRequest
	(*RevokePublicKeyResponse)(nil),        // 8: flipchat.account.v1.RevokePublicKeyResponse
	(*v1.PublicKey)(nil),                   // 9: flipchat.common.v1.PublicKey
	(*v1.Signature)(nil),                   // 10: flipchat.common.v1.Signature
	(*v1.UserId)(nil),                      // 11: flipchat.common.v1.UserId
	(*v1.Auth)(nil),                        // 12: flipchat.common.v1.Auth
}
var file_account_v1_account_service_proto_depIdxs = []int32{
	9,  // 0: flipchat.account.v1.RegisterRequest.public_key:type_name -> flipchat.common.v1.PublicKey
	10, // 1: flipchat.account.v1.RegisterRequest.signature:type_name -> flipchat.common.v1.Signature
	0,  // 2: flipchat.account.v1.RegisterResponse.result:type_name -> flipchat.account.v1.RegisterResponse.Result
	11, // 3: flipchat.account.v1.RegisterResponse.user_id:type_name -> flipchat.common.v1.UserId
	11, // 4: flipchat.account.v1.AuthorizePublicKeyRequest.user_id:type_name -> flipchat.common.v1.UserId
	9,  // 5: flipchat.account.v1.AuthorizePublicKeyRequest.public_key:type_name -> flipchat.common.v1.PublicKey
	10, // 6: flipchat.account.v1.AuthorizePublicKeyRequest.signature:type_name -> flipchat.common.v1.Signature
	12, // 7: flipchat.account.v1.AuthorizePublicKeyRequest.auth:type_name -> flipchat.common.v1.Auth
	1,  // 8: flipchat.account.v1.AuthorizePublicKeyResponse.result:type_name -> flipchat.account.v1.AuthorizePublicKeyResponse.Result
	11, // 9: flipchat.account.v1.RevokePublicKeyRequest.user_id:type_name -> flipchat.common.v1.UserId
	9,  // 10: flipchat.account.v1.RevokePublicKeyRequest.public_key:type_name -> flipchat.common.v1.PublicKey
	12, // 11: flipchat.account.v1.RevokePublicKeyRequest.auth:type_name -> flipchat.common.v1.Auth
	2,  // 12: flipchat.account.v1.RevokePublicKeyResponse.result:type_name -> flipchat.account.v1.RevokePublicKeyResponse.Result
	3,  // 13: flipchat.account.v1.Account.Register:input_type -> flipchat.account.v1.RegisterRequest
	5,  // 14: flipchat.account.v1.Account.AuthorizePublicKey:input_type -> flipchat.account.v1.AuthorizePublicKeyRequest
	7,  // 15: flipchat.account.v1.Account.RevokePublicKey:input_type -> flipchat.account.v1.RevokePublicKeyRequest
	4,  // 16: flipchat.account.v1.Account.Register:output_type -> flipchat.account.v1.RegisterResponse
	6,  // 17: flipchat.account.v1.Account.AuthorizePublicKey:output_type -> flipchat.account.v1.AuthorizePublicKeyResponse
	8,  // 18: flipchat.account.v1.Account.RevokePublicKey:output_type -> flipchat.account.v1.RevokePublicKeyResponse
